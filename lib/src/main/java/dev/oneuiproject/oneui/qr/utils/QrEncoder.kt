package dev.oneuiproject.oneui.qr.utils
 ...
 * ```
 *
 * @property context The Android [android.content.Context] used for resource access and density calculations.
 * @property content The string content to be encoded in the QR code.
 * @see dev.oneuiproject.oneui.widget.QRImageView
 */
open class QrEncoder(private val context: Context, private val content: String) {
